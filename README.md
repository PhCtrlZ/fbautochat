# fbautochat
*Instruction manual <space>
+If you uses username and password to login you must empty data in '' (no space) <space>
+If you login uses cookie you need take in your facebook <space>
-Example:
